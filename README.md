...
**This fork** publishes separately as [@hirez10/israeli-bank-scrapers](https://www.npmjs.com/package/@hirez10/israeli-bank-scrapers). Current semver in [`package.json`](./package.json) should match the latest **GitHub** release tag (**[`hirez-v1.0.15`](https://github.com/HirezRa/israeli-bank-scrapers/releases/tag/hirez-v1.0.15)** as of this doc update; see [all releases](https://github.com/HirezRa/israeli-bank-scrapers/releases) and [CHANGELOG](./CHANGELOG.md)). **npm** may lag GitHub if `npm publish` failed in CI — confirm the [package page](https://www.npmjs.com/package/@hirez10/israeli-bank-scrapers) version.
